...
\begin{itemize}
    \item \textbf{Exécution de code utilisateur} (boucles infinies, programmes trop lents, consommation CPU/mémoire) : Risque de blocage du système : arrêt forcé du processus.
